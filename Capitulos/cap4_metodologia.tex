...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item \textbf{Garantia de Disponibilidade}: O software será transferido para a instituição, com a elaboração de uma documentação para orientar a manutenção do sistema. (haver)
        \end{enumerate}
    \end{itemize}
\end{itemize}
