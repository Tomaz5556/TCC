...
\begin{itemize}
    ...
    \item \textbf{Padrões para nomes de guias e intervalos de células}: Explica a estrutura de colunas e linhas do \textit{Google Sheets}. Em seguida, foram definidos os nomes e intervalos das três guias essenciais para o correto funcionamento da plataforma, sendo elas: (explicar como funciona as colunas e linhas das planilhas)
    \begin{itemize}
