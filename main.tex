...
\begin{resumo}
	O presente trabalho teve como objetivo facilitar a exibição dos horários acadêmicos do IFNMG - Campus Salinas, tornando o acesso mais intuitivo, seguro e eficiente, em atendimento às demandas do setor de ensino. A pesquisa partiu do problema identificado no uso de planilhas do Google Sheets, cujo acesso compartilhado apresentava falhas de segurança e dificuldades de usabilidade, especialmente em dispositivos móveis e na busca por informações específicas. Para alcançar o objetivo proposto, foi adotada a metodologia de desenvolvimento de um sistema que integra tecnologias modernas, como Next.js, Tailwind CSS e Spring Boot, mantendo o Google Sheets como banco de dados. A implantação foi seguida por um processo de avaliação realizado com o responsável pela gestão dos horários acadêmicos, permitindo ajustes e melhorias. Os principais resultados incluem a criação de telas específicas para cursos, professores e salas, a implementação de uma tela de validação de dados com acesso restrito e a elaboração de uma documentação técnica da planilha. Conclui-se que a solução desenvolvida aumentou a confiabilidade, a acessibilidade e a organização dos dados, além de apresentar uma abordagem alternativa de banco de dados para sistemas web.
...
\include{Capitulos/cap2_objetivos}
\include{Capitulos/cap3_revisao}
